...
PATH=$PATH:/home/igaray/dotfiles/scripts:
...
#shopt -s histappend         # Share history across all terminals, append to (not overwrite) the history file
...
# Useful shortcuts
 ...
 alias         l1='ls --group-directories-first --color=auto -X -1'    #
 ...
 alias         lc="ls --group-directories-first --color=auto -X -ltcr" # sort by and show change time, most recent last
 alias         lu="ls --group-directories-first --color=auto -X -ltur" # sort by and show access time, most recent last
 alias         lt="ls --group-directories-first --color=auto -X -ltr"  # sort by date, most recent last
 alias         lr="ls --group-directories-first --color=auto -X -lR"   # recursive ls
...
#alias      emacs='emacs -nw'
 ...
 alias    winumnt='sudo umount /home/igaray/windows'
 alias    teramnt='sudo mount /dev/sdb1 /home/igaray/tera'
 alias   teraumnt='sync; sudo umount /home/igaray/tera'
 alias    usbumnt='sync; sudo umount /home/igaray/usb'
 alias  sdcardmnt='sudo mount /dev/mmcblk0p1 /media/sdcard'
 alias sdcardumnt='sync; sudo umount /media/sdcard'
 alias    suspend='sudo pm-suspend; fixkeyboard.sh'
 alias       soyw='cd ~/bin/soywiki; soywiki'
 alias     musika='ncmpcpp'
